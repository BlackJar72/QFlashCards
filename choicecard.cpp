...
void ChoiceCard::setData(CardEntry* data) {
	...
	while((i > -1) && (j < k)) {
		if(k == correctChoice) {
            choiceLabels[j]->setText(data->getAnswer());
		} else {
